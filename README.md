...
Invite your bot using the link (replace "\<client ID\>" with your bot ID): https://discord.com/api/oauth2/authorize?client_id=\<client ID\>&permissions=536870912&scope=applications.commands%20bot
