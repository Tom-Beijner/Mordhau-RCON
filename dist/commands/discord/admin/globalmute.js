...
class GlobalMute extends SlashCommand_1.default {
        ...
        try {
            Discord_1.ComponentConfirmation(ctx, {
                embeds: [
                    {
                        description: [
                            `Are you sure you want to globally mute ${player.name} (${PlayerID_1.outputPlayerIDs(player.ids, true)})?\n`,
                            `Duration: ${duration}`,
                        ].join("\n"),
                        color: 15158332,
                    },
